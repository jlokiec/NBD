...
public class FoulDao {
    ...
    private static final String AVG_FOR_LEAGUE = "select avg(sum_fouls) from game_results where league=:league allow filtering";
    private static final String AVG_FOR_LEAGUE_SEASON = "select avg(sum_fouls) from game_results where league=:league and season=:season allow filtering";
    private static final String SUM_COUNT_FOR_SEASON_HOME_TEAM = "select sum(sum_fouls), count(sum_fouls) from game_results where season=:season and home_team=:team allow filtering";
    private static final String SUM_COUNT_FOR_SEASON_AWAY_TEAM = "select sum(sum_fouls), count(sum_fouls) from game_results where season=:season and away_team=:team allow filtering";
    ...
    public double getAvgForSeasonAndTeam(String season, String team) {
        ...
        SumAndCount away = getFoulsSumAndCount(season, team, false);
    ...
    private SumAndCount getFoulsSumAndCount(String season, String team, boolean homeTeam) {
